...
It is not an error to request an index that is more than the length. Instead it evaluates to `nil`:
...
## What's next thing(s) on the list?
...
## Removing a thing from the list
